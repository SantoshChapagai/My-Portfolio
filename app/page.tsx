...
export default function Home() {
  return (
    <main className="flex flex-cols items-center justify-evenly p-24">
      ...
      <h3 className='text-xl p-4'>A Full-Stack Developer <span className='transition duration-1000 ease-in animate-pulse h-16 w-16'>👋</span></h3>
      ...
      <div className='bg-carolina rounded-3xl mt-10'>
        <Image src="/santosh.jpg" alt="santosh" width={768} height={512} className="object-contain rounded-full p-16 mr-16"/>
      </div>
    </main>
  )
}
