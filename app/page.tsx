...
export default function Home() {
  return (
    <main className="flex flex-cols items-center justify-evenly p-16">
      <div className='lg:max-w-[750px] mr-4'>
      <h1 className='text-3xl text-bold p-4'>Hello! I'm Santosh Chapagai</h1>
      <h3 className='text-xl p-4'>A Full-Stack Developer</h3>
      ...
      <div>
        <Image src="/santosh.jpg" alt="santosh" width={300} height={380} className="object-contain rounded-full"/>
      </div>
    </main>
  )
}
